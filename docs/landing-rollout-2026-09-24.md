...
- Main cohort: `public.funnel_events`, event_name='landing_view', path='/'. One row per session. Report this as sessions, not people.
...
Read-only query on 2026-09-24, KST days 2026-09-17 through 2026-09-23, path='/'. Last day's cohorts may not yet have 24 hours of follow-up. This is a reference snapshot, not the final matched baseline.
