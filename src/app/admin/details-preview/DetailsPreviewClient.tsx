...
const faqItems = [
  ...
  {
    id: "deposit",
    question: "참여 보증금은 무엇인가요?",
    answer: [
      "노쇼 방지 목적의 참여 보증금입니다. 모임에 정상 참여하면 전액 환급됩니다.",
    ],
  },
  {
    id: "confirmation",
    question: "참여 보증금을 입금하면 바로 확정되나요?",
    answer: [
      "참여 보증금을 입금하더라도 바로 확정되지는 않습니다. 입금 후에는 배정 대기 상태가 되며, 확정은 모임 시작 24시간 전에 이뤄집니다.",
      "나이대가 맞지 않거나 성비가 불균형해 모임이 진행되지 않는 경우에도 참여 보증금은 전액 환급됩니다.",
    ],
  },
] as const;
