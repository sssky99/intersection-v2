...
const faqItems = [
  ...
  },
  {
    ...
    answer: [
      "예약금을 입금하더라도 바로 확정이 되지는 않습니다. 예약금을 입금한 경우는 대기열 신청이며, 확정은 모임 시작 24시간 전에 이뤄집니다.",
      "저희는 여러분께 좋은 경험을 선사하는 것을 최우선으로 삼고 있습니다. 아쉽지만 나이대가 맞지 않거나 성비가 불균형한 경우 모임 진행이 어려울 수 있습니다. 해당 경우 마찬가지로 예약금은 전액 환급됩니다.",
    ],
  },
] as const;
