...
const funnelEvents = [
  ...
  "question_answered",
  "questions_complete",
  "guest_profile_ready_for_auth",
  "basic_info_start",
  "basic_info_name_view",
  "basic_info_phone_view",
  "basic_info_gender_view",
  "basic_info_birth_year_view",
...
const conversionBaseEvents: Record<string, string> = {
  ...
  question_view: "question_start",
  profile_photo_view: "question_start",
  profile_photo_submitted: "profile_photo_view",
  profile_complete: "profile_photo_submitted",
  invitation_yes: "profile_complete",
  ...
  payment_completed: "invitation_yes",
