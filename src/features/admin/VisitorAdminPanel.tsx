...
const eventLabels: Record<string, string> = {
  ...
  landing_page_visible_1s: "랜딩 정상 노출 1초",
  landing_cta_visible_1s: "CTA 실제 노출 1초",
  landing_first_interaction: "랜딩 첫 사용자 입력",
  landing_exit: "랜딩 이탈",
  ...
  basic_info_name_view: "이름 입력 도달",
  basic_info_phone_view: "전화번호 입력 도달",
  basic_info_gender_view: "성별 선택 도달",
  basic_info_birth_year_view: "출생연도 선택 도달",
  basic_info_mbti_view: "MBTI 선택 도달",
  basic_info_photo_view: "사진 등록 도달",
  basic_info_complete: "기본정보 완료",
  profile_photo_view: "사진 질문 도달",
  profile_photo_submitted: "프로필 사진 제출",
  ...
  invitation_yes: "초대 YES",
  payment_page_open: "그로블 결제창 이동",
