-- 0.5 is reserved for photos that cannot be assessed. Keep other ranges compatible.
    ...
    where
      ...
      and (
        ...
        or (
          ...
          and coalesce(nullif(trim(p.membership_status), ''), 'none') = 'none'
        )
      )
      and (
      ...
      and (
        ...
        or (p_operator_rating = '0.5' and r.rating = 0.5)
