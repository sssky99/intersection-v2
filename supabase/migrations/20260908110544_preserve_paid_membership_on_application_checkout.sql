...
begin
  ...
  where profile.user_id = p_user_id
    -- Checkout does not revoke paid access, including memberships starting later.
    -- Evaluate under the UPDATE row lock so a completed webhook wins.
    and profile.membership_status is distinct from 'active';
